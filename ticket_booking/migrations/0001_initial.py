    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticket_booking.theater')),
            ],
        ),
        migrations.CreateModel(
            name='Seat',
            fields=[
                ...
                ('show', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seats', to='ticket_booking.show')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('seats', models.ManyToManyField(related_name='bookings', to='ticket_booking.seat')),
